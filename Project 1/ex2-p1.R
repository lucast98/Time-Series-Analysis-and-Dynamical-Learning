...
p <- ggplot(ss, aes(x=Data, y=IBOVESPA)) + geom_line(color="blue") + theme_linedraw()
p + ggtitle("Índice de ações da IBOVESPA em função da data") + xlab("Data") + ylab("Índice de ações - Ibovespa")
